...
- /project: Initialize project structure
- /plan: Generate SPEC document
- /run: Execute DDD implementation
- /sync: Generate documentation
- /feedback: Collect improvement feedback

## Command Execution Rules

- After /plan: Execute /clear (mandatory)
- Token threshold: Execute /clear at >150K tokens
- Error handling: Use /feedback for all issues
```
