...
- Core Principle: 오케스트레이터가 위임 all work through Task() calls
...
from agent_foundation_core import TRUST5Validator
...
from agent_foundation_core import SPECManager, DDDExecutor, DocsGenerator
...
from agent_foundation_core import TaskAnalyzer, AgentRouter
...
from agent_foundation_core import TokenMonitor, ContextOptimizer
...
agent-trust check --all --verbose

# Token budget analysis
agent-context analyze --show-breakdown

# Agent routing debug
agent-tool route --task "description" --dry-run

# SPEC validation
agent-spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from agent_foundation_core import diagnose
...
- TRUST 5 logs: `.sudapapa/logs/trust5/`
- SPEC artifacts: `.sudapapa/specs/`
- Agent execution logs: `.sudapapa/logs/agents/`
- Token usage history: `.sudapapa/logs/tokens/`
...
- 에이전트 시스템 Documentation: See project README
...
- foundation-claude - Claude Code integration patterns
