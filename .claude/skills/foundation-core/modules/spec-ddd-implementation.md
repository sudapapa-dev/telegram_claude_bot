  ...
  spec-validation:
    ...
    steps:
      ...
      - name: Validate SPEC format
        run: python .sudapapa/scripts/validate_spec.py
      - name: Check requirement traceability
        run: python .sudapapa/scripts/check_traceability.py
  ...
  ddd-implementation:
    ...
    steps:
      ...
      - name: Verify tests exist for all requirements
        run: python .sudapapa/scripts/verify_test_coverage_mapping.py
  ...
  quality-gates:
    ...
    steps:
      ...
      - name: Validate TRUST 5
        run: python .sudapapa/scripts/validate_trust5.py
```
