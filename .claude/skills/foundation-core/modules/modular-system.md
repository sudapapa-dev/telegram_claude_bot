...
decision = splitter.should_split(".claude/skills/foundation-core/SKILL.md")
...
# Usage
organizer = SkillOrganizer(".claude/skills/foundation-core")
...
with open(".claude/skills/foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skills/foundation-core")
...
Commands:
- /plan - SPEC generation with modular docs
- /sync - Documentation sync to modular structure
