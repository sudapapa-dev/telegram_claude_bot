...
This directory contains 9 comprehensive modules covering 에이전트 시스템's foundational principles and execution rules:
...
- DDD implementation (/run)
- Documentation sync (/sync)
...
Agent Catalog - Complete reference of 에이전트 시스템's 26 specialized agents with 7-tier hierarchy.
...
Command Catalog - Complete reference for 에이전트 시스템's 6 core commands in SPEC-First DDD workflow.
...
skill_path = Path(".claude/skills/foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".claude/skills/foundation-core/modules")
 results = []
