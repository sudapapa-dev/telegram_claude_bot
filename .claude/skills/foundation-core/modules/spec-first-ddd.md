...
SPEC-First DDD is 에이전트 시스템's development methodology combining:

1. SPEC Generation - EARS format requirements (/plan)
2. Domain-Driven Development - ANALYZE-PRESERVE-IMPROVE (/run)
3. Documentation Sync - Auto-generated docs (/sync)

Three-Phase Workflow:
```
Phase 1: SPEC → spec-builder → .sudapapa/specs/SPEC-XXX/spec.md
...
Commands:
- /plan - SPEC generation (Phase 1)
- /run - DDD implementation (Phase 2)
- /sync - Documentation sync (Phase 3)
