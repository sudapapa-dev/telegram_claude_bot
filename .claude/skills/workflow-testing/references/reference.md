...
```bash
# CLI diagnostics
agent-workflow diagnose --full-check
agent-workflow test --dry-run --verbose
agent-workflow profile --list-available
agent-workflow review --show-rules
...
- Workflow logs: `.sudapapa/logs/workflow.log`
- Test results: `.sudapapa/test-results/`
- Profile data: `.sudapapa/profiles/`
- Review reports: `.sudapapa/reviews/`
- Debug sessions: `.sudapapa/debug-sessions/`
