...
Snapshot location: $CLAUDE_PROJECT_DIR/.sudapapa/cache/fix-snapshots/
...
Resume commands:
- /fix --resume (uses latest snapshot)
- /fix --resume fix-20260119-143052 (uses specific snapshot)
...
Team Prerequisites:
- workflow.team.enabled: true in .sudapapa/config/sections/workflow.yaml
...
12. Save snapshot to $CLAUDE_PROJECT_DIR/.sudapapa/cache/fix-snapshots/
