...
memory: user
skills: foundation-claude, foundation-core, workflow-project
---
...
- Trigger - User requests new plugin creation
...
Related Skills:
- foundation-claude - Claude Code authoring patterns, component references
...
Compliance: Claude Code Official Plugin Standards + 에이전트 시스템 Conventions
