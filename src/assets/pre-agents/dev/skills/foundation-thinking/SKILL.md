...
description: >
  ...
  Do NOT use for architecture decisions (use foundation-philosopher instead)
  or code quality validation (use foundation-quality instead).
license: Apache-2.0
...
metadata:
  ...
  related-skills: "foundation-philosopher"
...
Agent Teams:
- team-analyst: Primary user of Deep Questioning framework
- team-architect: Primary user of Critical Evaluation framework
- team-researcher: Uses all three for comprehensive analysis
...
- team-analyst: Primary consumer for plan phase analysis
- team-researcher: Comprehensive research methodology

Skills:
- foundation-philosopher: Complementary (Philosopher = strategic decisions, Thinking = creative analysis)
- foundation-core: Integration with SPEC workflow
- workflow-spec: Requirement documentation support

Commands:
- /plan: Apply thinking frameworks during specification
- /run: Reference during implementation decisions
