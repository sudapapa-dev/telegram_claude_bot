...
- `.sudapapa/docs/`: Project-specific documentation
- `.sudapapa/specs/`: Requirements and specifications
...
- `library-nextra`: Nextra documentation sites
- `foundation-context`: Token budget management
