...
metadata:
  ...
  related-skills: "lang-rust, domain-backend"
...
- domain-backend for REST API architecture and microservices
- lang-rust for systems programming companion
- quality-security for security hardening
- foundation-debug for performance profiling
- workflow-ddd for domain-driven development
