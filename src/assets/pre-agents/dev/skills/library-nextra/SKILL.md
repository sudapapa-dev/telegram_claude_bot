...
Complementary skills include docs-generation for auto-generating docs from code, workflow-docs for validating documentation quality, and cc-claude-md for Markdown formatting.
...
- docs-generation for content generation
- workflow-docs for documentation validation
- library-mermaid for diagram integration

Commands:

- /sync for documentation deployment
- /project for Nextra project initialization
