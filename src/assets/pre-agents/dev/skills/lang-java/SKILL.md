...
metadata:
  ...
  related-skills: "lang-kotlin, domain-backend"
...
- domain-backend for REST API, GraphQL, and microservices architecture
- domain-database for JPA, Hibernate, and R2DBC patterns
- foundation-quality for JUnit 5, Mockito, and TestContainers integration
- infra-docker for JVM container optimization
