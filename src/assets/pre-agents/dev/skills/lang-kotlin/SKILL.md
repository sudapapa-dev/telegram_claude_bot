...
- `domain-backend` - REST API, GraphQL, microservices architecture
- `domain-database` - JPA, Exposed, R2DBC patterns
- `quality-testing` - JUnit 5, MockK, TestContainers integration
- `infra-docker` - JVM container optimization
