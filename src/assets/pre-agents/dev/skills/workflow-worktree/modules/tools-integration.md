...
Purpose: Integration patterns for worktree-cli with development tools, IDEs, terminals, CI/CD pipelines, and monitoring systems.
...
- Run Tests: Execute /run for the SPEC
- Sync Worktree: Run worktree-cli sync command
...
- Command option completion for all worktree-cli subcommands
...
Navigation Aliases:
- mw: Short alias for worktree-cli
- mwl: List worktrees
...
- mwdev: Switch to worktree and start development with /run
