...
### Integration with 에이전트 시스템

This skill is designed for use within Claude Code during various development phases:

During the architecture phase with the /plan command, create system design diagrams to visualize proposed solutions and component relationships.

During the documentation phase with the /sync command, generate visual documentation including flowcharts, sequence diagrams, and architecture overviews.
...
Skills that complement this skill include docs-generation for comprehensive documentation generation, workflow-docs for diagram validation and documentation workflows, and library-nextra for architecture documentation sites.

Commands that utilize this skill include /sync for documentation with embedded diagrams and /plan for SPEC creation with visual architecture diagrams.
