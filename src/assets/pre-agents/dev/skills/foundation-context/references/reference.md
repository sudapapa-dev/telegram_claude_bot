...
- `foundation-claude`: Claude Code authoring and configuration
- `foundation-core`: Core execution patterns and SPEC workflow
- `workflow-project`: Project management and documentation
- `cc-memory`: Memory management and persistence
