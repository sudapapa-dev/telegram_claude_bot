...
class SessionManager:
    ...
    def __init__(self, storage_path: str = ".sudapapa/sessions"):
    ...
    def prepare_for_clear(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "reload_files": [
                "CLAUDE.md",
                f".sudapapa/specs/{self.current_session.work_state.current_spec}.md"
            ]
        }
...
task_ctx = TaskContext(
    ...
    key_artifacts={
        "spec_document": ".sudapapa/specs/SPEC-001.md",
        "architecture": ".sudapapa/architecture/SPEC-001.mermaid"
    }
)
...
class ClearStrategy:
    ...
    def prepare_clear_context(
        ...
        return {
            ...
            "reload_sequence": [
                "CLAUDE.md",
                f".sudapapa/specs/{session.work_state.current_spec}.md",
