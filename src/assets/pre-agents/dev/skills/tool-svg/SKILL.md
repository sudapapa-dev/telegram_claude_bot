...
metadata:
  ...
  related-skills: "domain-frontend, docs-generation"
...
- domain-frontend: React/Vue SVG component integration
- docs-generation: SVG diagram generation for documentation
- domain-uiux: Icon systems and design system integration
