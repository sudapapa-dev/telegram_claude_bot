...
- `domain-backend` - API design, database integration patterns
- `platform-deploy` - Azure, Docker, Kubernetes deployment
- `workflow-testing` - Testing strategies and patterns
- `foundation-quality` - Code quality standards
- `foundation-debug` - Debugging .NET applications
