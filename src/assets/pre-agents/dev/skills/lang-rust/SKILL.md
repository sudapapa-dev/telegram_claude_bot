...
- `domain-backend` - REST API architecture and microservices patterns
- `foundation-quality` - Security hardening for Rust applications
- `workflow-testing` - Test-driven development workflows
