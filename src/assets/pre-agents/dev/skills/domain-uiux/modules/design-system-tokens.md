---
name: foundation-uiux
description: 커스텀 디자인 시스템 - Professional implementation guide
version: 1.0.0
modularized: false
tags:
 - enterprise
...
- `library-shadcn` - shadcn/ui component library
- `code-frontend` - Frontend architecture patterns
- `lang-unified` - TypeScript best practices
