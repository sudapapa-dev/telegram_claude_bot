...
description: >
  ...
  (use domain-frontend instead) or shadcn/ui specifics
  (use library-shadcn instead).
license: Apache-2.0
...
- lang-typescript - TypeScript and JavaScript best practices
- foundation-core - TRUST 5 quality validation
- library-nextra - Documentation generation
- library-shadcn - shadcn/ui specialized patterns
...
- /run - DDD implementation cycle
- /sync - Documentation generation
