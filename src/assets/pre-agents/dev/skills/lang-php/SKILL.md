...
- domain-backend for REST API and microservices architecture
- domain-database for SQL patterns and ORM optimization
- workflow-testing for DDD and testing strategies
- platform-deploy for Docker and deployment patterns
- foundation-debug for AI-powered debugging
- foundation-quality for TRUST 5 quality principles
