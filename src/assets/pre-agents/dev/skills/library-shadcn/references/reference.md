...
- `domain-frontend` (Frontend development patterns)
- `baas-foundation` (Enterprise UI architecture)
- `security-api` (UI security implementation)
- `essentials-perf` (Performance optimization)
- `foundation-trust` (Accessibility and compliance)
- `domain-backend` (Backend integration)
- `baas-vercel-ext` (Frontend deployment)
- `domain-testing` (Component testing strategies)
