...
metadata:
  ...
  related-skills: "lang-typescript, lang-javascript, domain-frontend"
...
- domain-frontend for React or framework-based popup and side panel UI
- domain-backend for server-side API integration
- workflow-testing for extension testing strategies
...
Generated with: 에이전트 시스템 Skill Factory v1.0
