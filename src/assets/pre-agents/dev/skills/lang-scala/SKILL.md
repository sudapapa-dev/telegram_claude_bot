...
- domain-backend - REST API, GraphQL, microservices patterns
- domain-database - Doobie, Slick, database patterns
- workflow-testing - ScalaTest, MUnit, property-based testing
