...
description: >
  ...
  Do NOT use for code quality validation (use foundation-quality instead)
  or implementation workflows (use workflow-ddd instead).
license: Apache-2.0
...
- Apply Assumption Audit during /plan
...
Skills:
- foundation-core: Integration with TRUST 5 and SPEC workflow
- workflow-spec: Assumption documentation in SPEC format
- domain-backend: Technology-specific trade-off criteria
- domain-frontend: UI/UX decision frameworks

Commands:
- /plan: Apply Philosopher Framework during specification
- /run: Reference documented trade-offs during implementation
