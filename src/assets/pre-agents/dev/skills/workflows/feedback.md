...
The manager-quality agent executes: gh issue create --repo modu-ai-adk
...
- Description content
- Priority level
- Environment information (시스템 버전, OS)
...
- Phase 1 collects all user input at 오케스트레이터 level
...
- Phase 1: 오케스트레이터 (AskUserQuestion for feedback collection)
