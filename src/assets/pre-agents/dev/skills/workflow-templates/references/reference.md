...
from workflow_templates import TemplateOptimizer

optimizer = TemplateOptimizer("/project/.sudapapa")
...
```python
# Integration with /feedback command
from workflow_templates import FeedbackTemplateGenerator
...
from workflow_templates import VersionManager
...
- Solution: Review conflicts in `.sudapapa/merge-conflicts/` and resolve manually
...
from workflow_templates import diagnose
...
- Template storage: `.claude/skills/workflow-templates/templates/`
- Backups: `.sudapapa/backups/templates/`
- Merge conflicts: `.sudapapa/merge-conflicts/`
- Version history: `.sudapapa/config/template-versions.json`
- Feedback templates: `.claude/skills/workflow-templates/modules/feedback-templates.md`
...
- 에이전트 시스템 Templates Guide: See `modules/code-templates.md`
- Feedback Templates Reference: See `modules/feedback-templates.md`
- Template Optimizer Guide: See `modules/template-optimizer.md`

### Related Skills

- workflow-project - Project initialization with templates
- foundation-core - SPEC-driven template generation
