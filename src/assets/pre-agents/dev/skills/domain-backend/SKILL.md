...
description: >
  ...
  (use domain-database instead) or frontend implementation
  (use domain-frontend instead).
license: Apache-2.0
...
- domain-frontend - Full-stack development integration
- domain-database - Advanced database patterns
- foundation-core - MCP server development patterns for backend services
- quality-security - Security validation and compliance
- foundation-core - Core architectural principles
...
Maintained by: 에이전트 시스템 Backend Team
