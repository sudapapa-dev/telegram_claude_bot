...
For comprehensive testing patterns, see [examples.md](references/examples.md).
...
- `domain-backend` - API integration and backend communication
- `quality-security` - Mobile security best practices
- `foundation-debug` - Flutter debugging and DevTools
