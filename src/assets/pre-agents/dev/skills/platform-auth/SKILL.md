...
metadata:
  ...
  related-skills: "platform-supabase, platform-vercel, lang-typescript, domain-backend, expert-security"
...
- platform-supabase: Database with auth integration
- platform-vercel: Deployment with edge authentication
- lang-typescript: TypeScript patterns for auth SDKs
- domain-backend: Backend architecture with authentication
- domain-frontend: React/Next.js frontend integration
- expert-security: Security audit and threat modeling
