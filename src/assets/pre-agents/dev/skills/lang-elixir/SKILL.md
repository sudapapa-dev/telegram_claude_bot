...
- `domain-backend` - REST API and microservices architecture
- `domain-database` - SQL patterns and query optimization
- `workflow-testing` - DDD and testing strategies
- `foundation-debug` - AI-powered debugging
- `platform-deploy` - Deployment and infrastructure
