...
TRUST 5 is 에이전트 시스템's comprehensive quality assurance framework enforcing five pillars:
...
# Validate skill
result = validator.validate_skill(".claude/skills/foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".claude/skills/foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".claude/skills/foundation-core")
...
Commands:
- /plan - Generate SPEC with progressive detail
- /sync - Create docs with layered structure
