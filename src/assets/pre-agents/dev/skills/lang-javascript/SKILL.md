...
- domain-backend for API design and microservices architecture
- domain-database for database integration and ORM patterns
- workflow-testing for DDD workflows and testing strategies
- foundation-quality for code quality standards
- foundation-debug for debugging JavaScript applications
