...
description: >
  ...
  Do NOT use for writing tests (use workflow-testing instead)
...
- /run - DDD validation integration
- /sync - Documentation quality checks
- /feedback - Quality improvement feedback
