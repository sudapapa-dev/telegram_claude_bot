...
metadata:
  ...
  related-skills: "platform-auth, lang-typescript, domain-backend"
...
# platform-database-cloud: Cloud Database Platform Specialist
...
- domain-backend for backend architecture with database integration
- domain-mobile for mobile-first database patterns
- quality-security for security best practices (RLS policies, Security Rules)

---

Status: Production Ready
Generated with: 에이전트 시스템 Skill Factory v2.0
