...
Initialization:
```python
from agent_formats_data import TOONEncoder
...
Initialization:
```python
from agent_formats_data import JSONOptimizer
...
Initialization:
```python
from agent_formats_data import DataValidator
...
```python
from agent_formats_data import YAMLOptimizer
...
```python
from agent_formats_data import StreamProcessor
...
```python
from agent_formats_data import TOONEncoder, DataValidator
...
from agent_formats_data import TOONEncoder, JSONOptimizer
...
```python
from agent_formats_data import JSONOptimizer, DataValidator
