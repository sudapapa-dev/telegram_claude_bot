...
- domain-backend - Backend data serialization and API responses
- domain-database - Database data format optimization
- foundation-core - MCP data serialization and transmission patterns
- workflow-docs - Documentation data formatting
- foundation-context - Context optimization for token budgets
...
Maintained by: 에이전트 시스템 Data Team
