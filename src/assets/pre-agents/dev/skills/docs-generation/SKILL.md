...
Reference Skill("library-nextra") for comprehensive Nextra patterns.
...
Pattern for generating documentation from SPEC files:
...
Skills:
- library-nextra - Comprehensive Nextra documentation framework patterns
- lang-python - Python docstring conventions and typing
- lang-typescript - TypeScript/JSDoc documentation patterns
- domain-backend - API documentation for backend services
- workflow-project - Project documentation integration
...
Commands:
- /sync - Documentation synchronization with code changes
