...
User Request
    ↓
/plan "feature1" "feature2" "feature3" --worktree
    ↓
...
Worktree merge to main branch
    ↓
/sync SPEC-001 SPEC-002 SPEC-003
    ↓
...
- 에이전트 시스템 Plan-Run-Sync Workflow: Core methodology documentation
