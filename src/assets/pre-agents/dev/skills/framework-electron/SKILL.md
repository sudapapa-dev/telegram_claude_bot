...
metadata:
  ...
  related-skills: "lang-typescript, domain-frontend, lang-javascript"
---
...
- lang-typescript - TypeScript patterns for type-safe Electron development
- domain-frontend - React, Vue, or Svelte renderer development
- lang-javascript - Node.js patterns for main process
- domain-backend - Backend API integration
- workflow-testing - Testing strategies for desktop apps
