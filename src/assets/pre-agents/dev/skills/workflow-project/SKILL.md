...
# Workflow Project - Integrated Project Management System
...
- foundation-core: Core execution patterns and SPEC-driven development workflows
- foundation-claude: Claude Code integration and configuration
