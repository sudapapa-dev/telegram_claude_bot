# Workflow Project Menu Configuration Management

Unified configuration management system for workflow project operations, integrating 5 specialized modules into a single cohesive system.
...
```python
from workflow_project import create_config_manager, ConfigurationMigrator
...
from workflow_project import BatchQuestionsConfigManager
...
- cc-configuration: Claude Code configuration patterns
- core-workflow: Workflow-based configuration management
- quality-security: Security validation and compliance
