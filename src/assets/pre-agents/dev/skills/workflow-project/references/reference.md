...
- Initialization: `WorkflowProject(project_path: str)`
- Primary Methods:
...
```python
# Integration with /plan and /sync
from workflow_project import WorkflowProject

# Initialize project system
project = WorkflowProject("/path/to/project")

# After /plan generates SPEC
...
from workflow_project import TemplateOptimizer
...
- Project logs: `.sudapapa/logs/project.log`
- Template optimization logs: `.sudapapa/logs/template-optimizer.log`
- Language initialization logs: `.sudapapa/logs/language-init.log`
...
- 에이전트 시스템 Documentation: https://github.com-adk/docs
- Claude Code Skills Guide: https://docs.anthropic.com/claude-code/skills
- SPEC-First DDD Methodology: See `foundation-core/modules/spec-first-ddd.md`

### Related Skills

- foundation-core - Core execution patterns and SPEC workflow
- foundation-claude - Claude Code integration patterns
- workflow-docs - Unified documentation management
- workflow-templates - Template optimization strategies
- library-nextra - Advanced documentation architecture
