...
- domain-frontend for UI components and styling patterns
- domain-backend for API design and database integration
- library-shadcn for component library integration
- workflow-testing for testing strategies and patterns
- foundation-quality for code quality standards
- foundation-debug for debugging TypeScript applications
